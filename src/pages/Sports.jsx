    ...
    <>
      <nav className="hidden lg:block">
        <ul className="text-[#111111] text-xs flex flex-row gap-3 items-center justify-center">
          {navPaths
            .filter((path) => path.key === 3 && path.submenus)
            .map((path) =>
      ...
      <div className="max-w-[1300px] mx-auto p-4">
        <h2 className="border-b border-[#424242] pb-1 text-xl font-semibold mb-2 text-[#111111]">More from <span className="font-normal">Sports</span></h2>
