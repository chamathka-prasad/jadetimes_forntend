  ...
  return (
    <>
      <Section tag="div" className="relative md:p-4">
        {screenSize !== "small" && (
          <LatestUpdatesLink className="text-[0.625rem] md:mb-4 md:px-2 md:py-[0.15rem]" />
        )}
        <div className="md:grid md:grid-cols-2 md:gap-4 lg:grid-cols-[repeat(17,_minmax(0,_1fr))] lg:gap-5 xl:col-start-2 xl:col-span-10 xl:row-start-2">
          <article className="md:grid md:grid-cols-2 md:border md:border-neutral-300 md:col-span-2 lg:col-[13_span_/_13_span] lg:row-start-2">
            <div className="relative">
              {screenSize === "small" && (
                <LatestUpdatesLink className="px-3 py-2 text-sm absolute -bottom-9 left-1/2 -translate-x-1/2 -translate-y-1/2" />
              )}
            ...
            <div className="p-4 pt-8 flex flex-col gap-2 md:p-4 md:gap-4 lg:p-8">
              <div>
                {screenSize === "large" && (
                  <Link className="mb-1 lg:block lg:w-fit lg:text-xs">
                ...
                <div className="flex flex-col justify-between gap-4 lg:justify-normal lg:p-4">
                  {screenSize === "large" && (
                    <Link
                      ...
                      className="lg:w-fit text-sm font-light text-neutral-500 lg:order-[-1]"
                    >
                  ...
                  <Link
                    to={article.link}
                    className="overflow-wrap-anywhere line-clamp-2 lg:text-sm lg:line-clamp-3"
                  >
                    {article.title}
                  </Link>
                  {screenSize === "large" && (
                    <p className="lg:line-clamp-2 lg:text-xs">
                      {article.title}
                    </p>
                  )}
                  {screenSize !== "large" && (
              ...
              <div className="lg:col-span-2">
                ...
                >
                  <img
                    ...
                    className="md:h-[320px] lg:h-auto w-full"
                    loading="lazy"
                  />
                </a>
        ...
        <a
          ...
          className="hidden 2xl:block absolute top-[154px] -left-[118px] w-[117px]"
          target="_blank"
        ...
        <a
          ...
          className="hidden 2xl:block absolute top-[154px] -right-[118px] w-[117px]"
          target="_blank"
      ...
      <Section className="p-4">
        <h2 className="border-b-[3px] border-b-accent pb-1 font-semibold text-lg lg:mt-0 lg:text-xl">
          More News
        </h2>
        ...
        <div className="lg:grid lg:grid-cols-10 lg:mb-5">
                ...
                >
                  {screenSize !== "large" && (
                    <img
                      src={article.image}
                      alt=""
                      className="absolute top-0 h-full object-cover object-center -z-[1]"
                      loading="lazy"
                    />
                  )}
          ...
          {screenSize === "large" && (
            <FirstSlider articles={Articles.slice(0, 2)} />
          )}
          <section className="lg:pl-5 lg:border-l lg:border-neutral-300 lg:col-span-4 lg:flex lg:flex-col lg:gap-5">
            <div className="my-4 lg:mx-0 lg:flex lg:flex-row lg:gap-5 lg:items-center lg:my-0">
              ...
              {screenSize === "large" && (
                <LinkToMembership className="lg:font-semibold lg:text-[0.625rem]" />
              )}
            </div>
            <div className="flex flex-col gap-4 md:grid md:grid-cols-2 lg:grid-cols-2 lg:gap-5 lg:p-0">
              {Articles.slice(0, 8).map((article, index) => (
                <article
                  key={index}
                  className="flex flex-row p-4 gap-4 border border-neutral-300"
                >
                  <PictureLink
                  ...
                  <div className="flex flex-col justify-between lg:h-fit gap-4 lg:justify-normal lg:gap-2">
                    <Link
                      to={article.link}
                      className="line-clamp-2 overflow-wrap-anywhere lg:text-sm lg:line-clamp-3"
                    >
                      {article.title}
                    </Link>
                    {screenSize !== "large" && (
                    ...
                    {screenSize === "large" && (
                      <Link
                        to={article.categoryLink}
                        className="text-sm font-light w-fit text-neutral-500"
                      >
                        {article.categoryTitle}
                      </Link>
                    )}
            ...
            <div className="col-span-5 mt-12">
              <div className="flex flex-col gap-5 mb-5">
                {Articles.slice(0, 3).map((article, index) => (
                  <article
                    className="flex flex-row gap-4 border border-neutral-300 p-4"
                    key={index}
                  >
                    ...
                    <div className="flex flex-col gap-4 justify-between">
                      <Link
                        to={article.link}
                        className="line-clamp-3 overflow-wrap-anywhere text-sm"
                      >
                        {article.title}
                      </Link>
                      <Link
                        to={article.categoryLink}
                        className="inline-block w-fit text-sm text-neutral-500 font-light"
                      >
                        {article.categoryTitle}
                      </Link>
                    </div>
              ...
              <section>
                ...
                {Articles.slice(0, 6).map((article, index) => (
                  <Link
                    key={index}
                    to={article.link}
                    className="text-xs mb-3 line-clamp-2 overflow-wrap-anywhere last:mb-0"
                  >
                    {article.title}
                  </Link>
                ))}
          ...
          <section>
            ...
            {Articles.slice(0, 3).map((article, index) => (
              <article
                key={index}
                link={article.link}
                className="mb-4 md:last-of-type:mb-0 lg:odd:my-8 border border-neutral-300 lg:border-0"
              >
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-4 px-4 pb-4 lg:p-0">
                    ...
                    <Link
                      to={article.link}
                      className="text-lg line-clamp-2 lg:text-base lg:line-clamp-3"
                    >
                      {article.title}
                    </Link>
                  </div>
          ...
          <section>
            ...
            {Articles.slice(0, 3).map((article, index) => (
              <article
                key={index}
                link={article.link}
                className="mb-4 last-of-type:mb-0 lg:odd:my-8 border border-neutral-300 lg:border-0"
              >
                <div className="flex flex-col gap-4">
                  {screenSize !== "large" && (
                    <PictureLink link={article.link}>
            ...
            >
              <div className="flex flex-row p-4 gap-4 justify-between lg:justify-normal lg:p-0 lg:flex-col lg:gap-0">
                ...
                <div className="flex flex-col justify-between lg:justify-normal gap-4 lg:p-4">
                  ...
                  {screenSize !== "large" && (
                    <div className="whitespace-nowrap lg:text-xs lg:order-[-1]">
                      {article.posted}
                    </div>
                  )}
                </div>
      ...
      <Section
        tag="div"
        className="p-4 flex flex-col gap-4 md:grid md:grid-cols-3 lg:grid-cols-8 lg:gap-5 lg:py-5"
      >
          ...
          <article className="border border-neutral-300 lg:col-span-2 h-full lg:h-auto lg:border-none flex flex-row p-4 justify-between md:justify-normal gap-4 md:gap-0 lg:gap-2 md:p-0 md:flex-col">
            ...
            >
              <img
                src={Articles[0].image}
                alt=""
                className="min-w-24 w-24 min-h-24 h-24 object-cover object-center md:w-full md:h-full"
              />
            </PictureLink>
            <div className="flex flex-col justify-between md:justify-normal gap-4 md:p-4 lg:p-0">
              <Link
                to={Articles[0].link}
                className="overflow-wrap-anywhere line-clamp-2 lg:text-lg lg:font-medium lg:text-heading"
              >
                {Articles[0].title}
              </Link>
              {screenSize !== "large" && (
                <div className="whitespace-nowrap lg:text-xs md:order-[-1]">
                  {Articles[0].posted}
                </div>
              )}
            </div>
            ...
            <div className="lg:flex lg:flex-col lg:gap-5">
              {Articles.slice(0, 3).map((article, index) => (
                ...
                >
                  ...
                  <Link
                    to={article.link}
                    className="overflow-wrap-anywhere text-sm line-clamp-3"
                  >
                    {article.title}
                  </Link>
                </article>
        ...
        <div className="block aspect-square border border-neutral-300 h-full md:w-full lg:aspect-auto lg:col-span-4 lg:border-none">
          <article className="h-full relative">
            ...
            <div className="flex flex-col justify-between h-full p-4 bg-[#000000aa] lg:h-auto lg:bg-white lg:gap-2 lg:p-0 lg:justify-normal lg:mt-2">
              <Link
                to={Articles[0].link}
                className="order-2 line-clamp-3 text-white text-lg lg:text-2xl lg:line-clamp-2 lg:font-medium lg:text-heading"
              >
                {Articles[0].title}
              </Link>
              {screenSize === "large" && (
                <p className="lg:line-clamp-2 lg:text-lg lg:order-3">
                  {Articles[0].title}
                </p>
              )}
              {screenSize !== "large" && (
                <div className="whitespace-nowrap text-white lg:text-xs lg:text-neutral-900">
                  {Articles[0].posted}
                </div>
              )}
            </div>
      ...
      {screenSize === "large" && <YouTubeShorts />}
    </>
  );
};
