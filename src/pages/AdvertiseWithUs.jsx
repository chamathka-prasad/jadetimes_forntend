...
const AdvertiseWithUs = () => {
  return (
    <section className="p-4 max-w-[1000px] mx-auto">
      <h1 className="text-neutral-900 text-2xl font-semibold border-b border-b-neutral-300 pb-1 md:text-center md:text-2xl md:pb-4 lg:text-3xl lg:py-8 lg:pb-11">Contact Us</h1>
      ...
      <ShowCard className="mb-7 flex flex-col gap-4 md:grid md:grid-cols-2 md:gap-5 lg:grid-cols-3" />
      ...
      <div className="md:grid md:grid-cols-2 md:mb-4">
        <Form className="text-sm flex flex-col gap-4 mt-4 md:pr-5 md:border-r md:border-r-neuborder-b-neutral-300" />
