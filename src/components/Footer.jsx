        ...
        <div>
          <nav className="border-t border-b border-neutral-200 py-4">
            <ul className="text-neutral-800 flex flex-wrap items-center gap-4 justify-center text-xl mb-4">
              <li className="flex"><a href="https://www.whatsapp.com/channel/0029VaevKQj35fM4n9S7ub1c" aria-label="whatsapp" target="_black" className="p-2 inline-block rounded-full duration-500 border border-white hover:text-black hover:border-neutral-800"><FaWhatsapp /></a></li>
              <li className="flex"><a href="https://www.tiktok.com/@jadetimes_officials" aria-label="tiktok" target="_blank" className="p-2 inline-block rounded-full duration-500 border border-white hover:text-black hover:border-neutral-800"><FaTiktok /></a></li>
              <li className="flex"><a href="https://x.com/jade_times" aria-label="x-twitter" target="_blank" className="p-2 inline-block rounded-full duration-500 border border-white hover:text-black hover:border-neutral-800"><FaXTwitter /></a></li>
              <li className="flex"><a href="https://www.facebook.com/officialJadetimes" aria-label="facebook" target="_blank" className="p-2 inline-block rounded-full duration-500 border border-white hover:text-black hover:border-neutral-800"><FaFacebookF /></a></li>
              <li className="flex"><a href="https://www.youtube.com/channel/UCh3RLLVBaEeBRRZBbnnVWWA" aria-label="youtube" target="_blank" className="p-2 inline-block rounded-full duration-500 border border-white hover:text-black hover:border-neutral-800"><FaYoutube /></a></li>
              <li className="flex"><a href="https://www.instagram.com/jadetimes_official/" aria-label="instagram" target="_blank" className="p-2 inline-block rounded-full duration-500 border border-white hover:text-black hover:border-neutral-800"><FaInstagram /></a></li>
              <li className="flex"><a href="https://www.linkedin.com/company/99353290/admin/feed/posts/" aria-label="linkedin" target="_blank" className="p-2 inline-block rounded-full duration-500 border border-white hover:text-black hover:border-neutral-800"><FaLinkedinIn /></a></li>
            </ul>
