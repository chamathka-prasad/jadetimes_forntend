...
const Header = (props) => {
  return (
    <header className="bg-neutral-900 text-white sticky top-0 z-10">
      <div className="p-4 flex items-center max-w-[1380px] mx-auto">
        ...
        <Link to="/membership" className=" hidden md:block bg-red-600 font-medium text-xs py-1 px-2 order-2 ml-6 duration-500 hover:bg-white hover:text-black w-40 text-center uppercase whitespace-nowrap">
