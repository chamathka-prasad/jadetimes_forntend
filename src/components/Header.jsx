  ...
  return (
    <header className="bg-black text-white sticky top-0">
      <div className="p-4 flex items-center max-w-7xl mx-auto">
        ...
        <Link to="/membership" className=" hidden sm:block bg-red-600 font-medium text-xs py-1 px-2 order-2 ml-6 duration-500 hover:bg-white hover:text-black w-40 text-center uppercase" >Subscribe : 49.99/Year</Link>
        <div className="w-40 hidden sm:block order-4 mr-6 fonmt-medium text-right">
