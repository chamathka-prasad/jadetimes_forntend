...
const SignIn = ({ handleSignInOff, handleNavItem }) => {
  ...
  return (
    <div className="fixed w-screen top-0 bottom-0 left-0 z-[100] bg-white text-neutral-900 p-4 pt-[71.97px] lg:pt-[59.9px] overflow-y-auto lg:flex lg:items-center lg:justify-center">
      {isLogIn ? (
        isResetPassword ? (
      ...
      <div className="absolute top-0 left-0 right-0 px-4 py-[1.45rem] lg:py-[1.10rem] flex max-w-[1260px] mx-auto">
        <CloseButton
          className="text-black ml-auto w-[1.7rem] h-8"
