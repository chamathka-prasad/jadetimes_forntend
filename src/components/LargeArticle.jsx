...
const LargeArticle = () => {
    return (
        <Link className="block border-b border-b-neutral-300 sm:border sm:border-neutral-300 sm:col-span-2 lg:col-span-4 xl:col-start-1 xl:col-end-9 xl:row-start-2 xl:row-end-5">
            <article className="sm:grid sm:grid-cols-2 xl:h-full">
                <picture>
                ...
                <div className="py-6 px-4 flex flex-col justify-between gap-2 lg:p-6 lg:justify-center">
